...
void RobotMap::init() {
    ...
    driveTrainbackLeft.reset(new CANTalon(14));
    lw->AddActuator("DriveTrain", "backLeft", driveTrainbackLeft);
    
    driveTrainbackRight.reset(new CANTalon(12));
    lw->AddActuator("DriveTrain", "backRight", driveTrainbackRight);
    
    driveTrainfrontLeft.reset(new CANTalon(15));
    lw->AddActuator("DriveTrain", "frontLeft", driveTrainfrontLeft);
    
    driveTrainfrontRight.reset(new CANTalon(13));
